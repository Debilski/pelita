...
class SVGViewer:
    ...
    def show_state(self, game_state):
        ...
        <g id="pacman">
        <path d="M 9.98 7.73 A 4.38 4.38 0 1 1 9.98 3.8 L 6.05 5.8 Z"/>
        </g>
        ...
        Path(f"pelita-{self.index}.svg").write_text(template)
        self.index += 1
